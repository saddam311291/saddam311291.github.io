...
export default function Page() {
  return (
    ...
    <div className="flex-grow p-6 md:overflow-y-auto bg-gray-50  md:p-12 flex flex-col md:flex-row md:overflow-hidden">
      <div className="flex flex-col w-full shadow-2xl bg-gray-150 md:flex-grow p-4 md:overflow-hidden md:flex-row">
        ...
        <div className="flex flex-col bg-gray-150 md:flex-grow p-4 md:mt-10 md:overflow-hidden md:w-3/4">
          {/* <AppImage /> */}
          <SummaryText />
        </div>
      </div>
