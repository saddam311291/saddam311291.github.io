  ...
  const cardData = [
    {
      ...
      technologies: "MS SQL Server, PHP,Zend, Laravel, JavaScript, jQuery, Python, Django, React.js",
  ...
  const cardData = [
    {
      ...
      technologies: "MS SQL Server, PHP,Zend, Laravel, JavaScript, jQuery, Digital Payment Getway",
  ...
  const cardData = [
    {
      ...
      technologies: "MS SQL Server, PHP,Zend, Laravel, JavaScript, jQuery, NID Verification",
